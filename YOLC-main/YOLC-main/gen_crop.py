...
def convert_to_cocodetection(dir, output_dir):
    train_dir = os.path.join(dir, "VisDrone2019-DET-test")
    train_annotations = os.path.join(train_dir, "annotations")
    train_images = os.path.join(train_dir, "images")

    out_dir = os.path.join(dir, "VisDrone2019-DET-test-crop")
...
if __name__ == '__main__':
    path = "/mnt/home/hks/平铺/YOLC-main/YOLC-main/data/VisDrone2019"
